...
Qno2:A university has the following rules for a student to qualify for a degree with A as the main subject and B 
...
Qno3:Find the absolute value of a number entered through the keyboard
